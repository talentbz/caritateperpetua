...
use PYS_PRO_GLOBAL\FacebookAds\Object\Fields\NativeOfferViewFields;
/**
 ...
 *
 */
class NativeOfferView extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    /**
    ...
    {
        return \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\NativeOfferViewFields::getInstance();
    }
    ...
    {
        $this->assureId();
        $param_types = array('ad_account' => 'string', 'ad_image_hashes' => 'list<string>', 'file' => 'file', 'image_crops' => 'list<map>', 'photos' => 'list<string>', 'urls' => 'list<string>');
        $enums = array();
    ...
    public function getSelf(array $fields = array(), array $params = array(), $pending = \false)
    {
        ...
        $param_types = array();
        $enums = array();
        $request = new \PYS_PRO_GLOBAL\FacebookAds\ApiRequest($this->api, $this->data['id'], \PYS_PRO_GLOBAL\FacebookAds\Http\RequestInterface::METHOD_GET, '/', new \PYS_PRO_GLOBAL\FacebookAds\Object\NativeOfferView(), 'NODE', \PYS_PRO_GLOBAL\FacebookAds\Object\NativeOfferView::getFieldsEnum()->getValues(), new \PYS_PRO_GLOBAL\FacebookAds\TypeChecker($param_types, $enums));
        $request->addParams($params);
        $request->addFields($fields);
        return $pending ? $request : $request->execute();
    }
    ...
    {
        $this->assureId();
        $param_types = array('message' => 'string', 'published' => 'bool', 'published_ads' => 'bool');
        $enums = array();
