...
function remove_checkout_fields( $fields ) {
	$fields['billing_first_name']['placeholder'] ='Prénom';
	$fields['billing_first_name']['label'] ='Prénom';
	
	$fields['billing_address_1']['placeholder'] ='Numéro et adresse de rue';
	return $fields;
}
...
$translated = str_ireplace('Street address', 'Numéro et nom de rue', $translated);
